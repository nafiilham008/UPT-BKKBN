            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of link.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Link') }}</li>
                </x-breadcrumb>
            </div>
        </div>
        ...
        <section class="section">
            ...
            @can('link create')
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.links.create') }}" class="btn btn-primary mb-3">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="avatar avatar-xl"
                                                        src="{{ asset('uploads/images/link/' . $item->photo) }}"
