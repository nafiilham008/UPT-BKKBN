...
@section('title', __('Add Structure'))
        ...
        <section class="section">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.structures.store') }}" method="POST"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="file" id="photo" name="photo"
                                                accept="image/png, image/jpeg, image/svg+xml" data-parsley-required="true"
                                                data-parsley-filemaxmegabytes="5" data-parsley-trigger="change"
