            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of employee.') }}
                    </p>
                </div>
                <x-breadcrumb>
        ...
        <section class="section">
            ...
            @can('employee create')
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.employees.create') }}" class="btn btn-primary mb-3">
                                                ...
                                                <td>
                                                    @if (empty($item->photo))
                                                        <img class="avatar avatar-xl"
                                                            src="{{ asset('img/avatar-default/default.png') }}"
