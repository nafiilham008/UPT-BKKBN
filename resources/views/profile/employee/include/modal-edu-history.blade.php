<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <form id="form-education-history" method="POST" enctype="multipart/form-data" data-parsley-validate>
            @csrf
            @method('POST')
            <div class="modal-content">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mandatory">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="{{ __('Insert description') }}"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" id="save-education" data-id="{{ $employee->id }}" class="btn btn-primary ml-1" data-bs-dismiss="modal">
