...
@section('title', __('Verification Account'))
    ...
    <div class="relative bg h-auto">
        <div class="flex flex-col justify-center items-center py-28">
            ...
            <div class="rounded-[24px] bg-white/40 py-[22px] w-[522px] box-shadow">
                ...
                <h1 class="font-be-vietnam text-xs font-medium text-center text-[#272727]/70">Enter your verification code
                    that we have sent via email</h1>
                <h1 id="maskedEmail" class="font-be-vietnam text-xs font-medium text-center text-[#272727]/70">{{ $user->email }}
                </h1>
                <div class="px-20 py-10">
                    <form action="{{ route('remaja.verification.confirm', $user->verification_code) }}" method="POST">
                        @csrf
                        <div class="mb-7">
                    ...
                    <div class="flex justify-between">
                        ...
                        <a href="{{ route('remaja.verification.resend', $user->id) }}" class="font-be-vietnam text-xs resendButton cursor-not-allowed text-[#808080]" disabled>Resend Code</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function countdown(minutes) {
            ...
            const countdownInterval = setInterval(() => {
                ...
                countdownElement.textContent = displayMinutes.toString().padStart(2, '0') + ':' + displaySeconds
