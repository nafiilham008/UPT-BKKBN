...
@section('content')
    <div>
        ...
        <div class="bg-white relative px-[200px] py-7">
            <div class="flex gap-8 items-center mb-16">
                ...
                <h1 class="text-[40px] text-[#272727] font-bold font-be-vietnam">About Menjadi Remaja</h1>
            </div>
            <div class="grid grid-cols-3 gap-[30px] justify-center items-center mb-24">
