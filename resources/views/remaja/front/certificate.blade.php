                ...
                <div class="">
                    ...
                    <div class="px-[185px]">
                        <div class="rounded-[24px] flex flex-col gap-10 items-center justify-center min-h-[600px] bg-white/40"
                            ...
                            <div class="relative">
                                <img src="../img/remaja/assets/sertifikat.svg" alt="">
                                ...
                                <div class="absolute top-52 left-[54px]">
                                    <h1 class="font-montserrat  text-[8px] w-[360px]">Telah Menyelesaikan Game <label
                                            class="font-semibold">“Nama Game”</label> pada <label
                                            class="font-semibold">“tangga main”</label></h1>
                                </div>
                                <div class="absolute top-[310px] left-[54px] w-[100px]">
                                    <h1 class="font-montserrat font-semibold text-center text-[8px]">Nur Hidayati, SP.</h1>
                                </div>
                                <div class="absolute top-[330px] left-[54px] w-[100px]">
                                    <h1 class="font-montserrat text-center text-[6px]">Kasubag TU UPT Balai Diklat KKB
                                        Banyumas</h1>
                                </div>
