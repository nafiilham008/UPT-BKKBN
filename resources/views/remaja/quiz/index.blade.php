            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of all quiz.') }}
                    </p>
                </div>
                <x-breadcrumb>
        ...
        <section class="section">
            ...
            @can('quiz create')
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.quizzes.create') }}" class="btn btn-primary mb-3">
