<div class="modal fade" id="exampleModalScrollableEdit{{ $id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <form id="form-category-edit{{ $id }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
            @csrf
            @method('POST')
            <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mandatory">
                                ...
                                <input type="text" name="title" id="title_category"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="update-category{{ $id }}" data-id="{{ $id }}" class="btn btn-primary ml-1" data-bs-dismiss="modal">
