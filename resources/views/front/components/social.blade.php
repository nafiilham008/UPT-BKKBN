<div class="">
    <div class="bg-[#0672B0] px-5 py-4 rounded-t-xl">
        <h1 class="text-white text-lg font-semibold" style="font-family: 'Poppins', sans-serif;">Social
            Media
        </h1>
        <div class="flex gap-1">
            ...
            <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="36"
                    width="36" viewBox="-19.5036 -32.49725 169.0312 194.9835">
                    <defs>
    ...
    <div class="bg-white shadow-xl rounded-b-xl p-10">
        <div class="flex justify-center">
            <iframe
                src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FBKKBNOfficial&tabs=timeline&width=355&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=false&appId"
                width="355" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0"
