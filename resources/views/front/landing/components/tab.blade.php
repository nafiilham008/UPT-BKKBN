                            ...
                            <div class="grid grid-cols-12 mt-5">
                                ...
                                <div class="col-span-8 px-4 flex flex-col justify-center">
                                    <a href="#" class="text-base text-[#2B5268] font-semibold "
                                        style="font-family: 'Poppins', sans-serif;">{{ $item->title }}
                                    </a>
                                    <h1 class="text-sm text-justify text-[#434343] py-3 line-clamp"
                                        style="font-family: 'Poppins', sans-serif;">{!! strip_tags($item->description, '<p></p>') !!} 
                                    </h1>
                                    <a href="#" class="text-base text-[#2B5268] ml-1 font-semibold">Selengkapnya</a>
                                    <div class="flex">
                                        <div class="flex">
