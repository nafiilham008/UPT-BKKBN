...
@section('title', __('Public Information'))
...
@section('content')
    <div class="page-heading">
            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of public information.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Public Information') }}</li>
                </x-breadcrumb>
            </div>
        </div>
        ...
        <section class="section">
            ...
            @can('public-information create')
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.public-informations.create') }}" class="btn btn-primary mb-3">
