...
@section('title', __('Edit Scholarship'))
        ...
        <section class="section">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.scholarships.update', $scholarship->id) }}" method="POST"
                                    ...
                                    <div class="col-md-1 text-center"
                                        ...
                                        <div class="avatar avatar-xl">
                                            <img style="object-fit: cover"
                                                src="{{ asset('uploads/images/information/scholarship/' . $scholarship->photo) }}"
                                                alt="avatar">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                                ...
                                                data-parsley-required-message="The Description field is required!">{{ $scholarship->description }}</textarea>
                                            @error('description')
                                                <span class="text-danger">
                                                    {{ $message }}
                                                </span>
                                ...
                                <a href="{{ route('dashboard.scholarships.index') }}"
