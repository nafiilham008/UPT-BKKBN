...
@section('title', __('Button Banner'))
...
@section('content')
    <div class="page-heading">
            ...
            <div class="row">
                <div class="col-12 col-md-8 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">
                        {{ __('Below is a list of button banner.') }}
                    </p>
                </div>
                <x-breadcrumb>
                    <li class="breadcrumb-item"><a href="{{ url('dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Button Banner') }}</li>
                </x-breadcrumb>
            </div>
        </div>
        ...
        <section class="section">
            ...
            @can('button-banner create')
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.button-banners.create') }}" class="btn btn-primary mb-3">
                        <i class="fas fa-plus"></i>
                        {{ __('Add button banner') }}
                    </a>
                </div>
            @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img class="avatar avatar-xl"
                                                        src="{{ asset('uploads/images/information/button-banner/' . $item->photo) }}"
                                                ...
                                                @include('information.button-banner.include.action')
