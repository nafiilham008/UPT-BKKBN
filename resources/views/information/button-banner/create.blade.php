...
@section('title', __('Add Button Banner'))
        ...
        <section class="section">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.button-banners.store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mandatory">
                                            ...
                                            <input type="text" name="title" id="title"
                                                ...
                                                placeholder="e.g. Pengumuman" data-parsley-required="true"
